                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                @if (Storage::exists('public/' . $user->avatar))
                                    <img id="image_preview" class="avatar avatar-xl" style="background-image: url('{{ asset('storage/'.$user->avatar) }}');"></img>
                                @else
                                    <img id="image_preview" class="avatar avatar-xl" style="background-image: url('{{ asset($user->avatar) }}');"></img>
                                @endif
                            </div>
                            <div class="col-auto">
                                <input type="file" class="form-control" name="image" id="upload_image" onchange="previewImage()">
